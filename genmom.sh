...
while [ "$d" != "$y" ]; do 
 ...
 then
 #The main idea is to isolate the list of 2nd years using 2nd grep and find the last element of list and then the first word of the last element,which is the username
